			...
			<table class="table table-bordered" style="margin-bottom: 10px">
					...
					<tr>
						<th colspan="2" style="text-align: center">CHECK IN</th>
							...
							<tbody>
					<tr>
						<th style="text-align: center; width: 40%" id="detail-checkin">-</th>

...
<div class="main-content pre-posttest">
    <h3 class="card-title">
        <strong>MASTER DATA - DISTRICTS</strong>
    </h3>
    ...
    <table class="table table-bordered table-hover" id="example1">
        <thead>
            <tr>
                ...
                <th style="text-align: center;">PLANT AREA</th>
		...
		<?php foreach ($datatable as $i => $v): ?>
			<tr>
				...
				<td style="text-align: center; vertical-align: middle">
					<a href="<?= admin_url('master/districts/edit/'.$v['ID_DISTRICTS']) ?>"class="btn btn-sm"><i class="fas fa-pen text-warning"></i></a>
					<a href="<?= admin_url('master/districts/detail/'.$v['ID_DISTRICTS']) ?>" class="btn btn-sm"><i class="fas fa-eye text-success"></i></a>
				</td>
			</tr>
		<?php endforeach ?>
        </tbody>

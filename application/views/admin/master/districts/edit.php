...
<div class="main-content pre-posttest">
    ...
    <div class="row" style="align-items: center; justify-content: center; min-height: 80vh">
        <form class="form-category" action="<?= admin_url('master/districts/do_update') ?>" method="POST" enctype="multipart/form-data">
            <input type="hidden" name="id_districts" value="<?= $model['ID_DISTRICTS'] ?>">
                            ...
                            <tbody>
                                <tr>
                                    <td data-label="province">
                                        <input type="text" class="form-control" autocomplete="off" style="font-size: 14px !important; text-align: left" value="<?= $model['PROVINCE_NAME'] ?>" readonly>
                                    </td>
                                    <td data-label="regencies">
                                        <input type="text"  class="form-control" autocomplete="off" style="font-size: 14px !important; text-align: left" value="<?= $model['REGENCIES_NAME'] ?>" readonly>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                        <table class="table table-bordered" style="margin-bottom: 0px">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align: left">PLANT AREA</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>

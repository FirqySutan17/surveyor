...
<div class="main-content pre-posttest">
    ...
    <div class="row w-form">
        <div class="c-form">
            <form action="<?= admin_url('master/warehouse/do_create') ?>" method="POST" enctype="multipart/form-data">
                <div class="form-group row">
                    <label for="nama" class="col-lg-12 col-sm-12 col-form-label">Nama <span class="text-danger">*</span></label>
                    <div class="col-lg-12 col-sm-12">
                        <input type="text" name="nama" class="form-control" placeholder="Type here.." autocomplete="off" required>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-12 col-sm-12">
                        <input type="text" name="owner" class="form-control" placeholder="Type here.." autocomplete="off">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="phone_number" class="col-lg-12 col-sm-12 col-form-label">Nomor HP <span class="text-danger">*</span></label>
                    <div class="col-lg-12 col-sm-12">
                        <input type="text" name="phone_number" class="form-control" placeholder="Type here.." autocomplete="off" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="location" class="col-lg-12 col-sm-12 col-form-label">Lokasi</label>
                    <div class="col-lg-12 col-sm-12">
                        <input type="text" name="location" class="form-control" placeholder="Type here.." autocomplete="off">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="classification" class="col-lg-12 col-sm-12 col-form-label">Klasifikasi <span class="text-danger">*</span></label>
                    <div class="col-lg-12 col-sm-12">
                        <input type="text" name="classification" class="form-control" placeholder="Type here.." autocomplete="off" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="capacity" class="col-lg-12 col-sm-12 col-form-label">Kapasitas <span class="text-danger">*</span></label>
                    <div class="col-lg-12 col-sm-12">
                        <input type="text" name="capacity" class="form-control" placeholder="Type here.." autocomplete="off" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="fasilitas" class="col-lg-12 col-sm-12 col-form-label">Fasilitas</label>
                    <div class="col-lg-12 col-sm-12">
                        <input type="text" name="fasilitas" class="form-control" placeholder="Type here.." autocomplete="off">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="kategori" class="col-lg-12 col-sm-12 col-form-label">Kategori</label>
                    <div class="col-lg-12 col-sm-12">
                        <input type="text" name="kategori" class="form-control" placeholder="Type here.." autocomplete="off">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="area" class="col-lg-12 col-sm-12 col-form-label">Area <span class="text-danger">*</span></label>
                    <div class="col-lg-12 col-sm-12">
                        <input type="text" name="area" class="form-control" placeholder="Type here.." autocomplete="off" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="remarks" class="col-lg-12 col-sm-12 col-form-label">Remarks</label>
                    <div class="col-lg-12 col-sm-12">
                        <input type="text" name="remarks" class="form-control" placeholder="Type here.." autocomplete="off">
                    </div>
                </div>

                        ...
                        <?php for ($i=10; $i >= 0; $i--) { ?>
                            <tr>
                                ...
                                <div class="harvest-mobile" style="display: flex; ">
                                    <td data-label="BARIS">
                                        <input name="baris[${index}][]" value="${list_harvest[index]['BARIS']}" type="text" placeholder="0" style="width: 100%; padding: 8px 10px; border-radius: 5px; text-align: left; border: 1px solid #000" readonly>
                                    </td>
                                ...
                                <div class="harvest-mobile">
                                    <td data-label="BIJI">
                                        <input name="biji[${index}][]" value="${list_harvest[index]['BIJI']}" type="text" placeholder="0" style="width: 100%; padding: 8px 10px; border-radius: 5px; text-align: left; border: 1px solid #000" readonly>
                                    </td>
                                    <td data-label="ACTUAL">
                                ...
                                <div class="harvest-mobile">
                                    <td data-label="BOBOT">
                                        <input name="bobot[${index}][]" value="${list_harvest[index]['BOBOT']}" type="text" placeholder="0" style="width: 100%; padding: 8px 10px; border-radius: 5px; text-align: left; border: 1px solid #000" readonly>
                                    </td>
                                    <td data-label="ACTUAL">

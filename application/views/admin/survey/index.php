        ...
        <tbody>
            <?php foreach ($datatable as $i => $v): ?>
                <tr>
                    ...
                    <td data-label="ADDRESS" class="address" style="vertical-align: middle;"><?= $v['DESCRIPTION'] ?></td>
                    ...
                    <td style="vertical-align: middle">
                        ...
                        <a href="<?= admin_url('survey/detail/'.$v['SURVEY_NO']) ?>" target="_blank" class="btn btn-sm btn-show-detail" title="Detail"><i class="fas fa-eye text-primary"></i></a>
                    </td>
                </tr>
            <?php endforeach ?>
        </tbody>

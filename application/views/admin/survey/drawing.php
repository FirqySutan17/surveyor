        ...
        <form action="<?= admin_url('visit/do_create') ?>" method="POST" enctype="multipart/form-data">
            <div class="content-task mt-5">
                ...
                <div class="table-responsive mt-2">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td data-label="LATITUDE">
                                    <div id="latitude">-6.2336204</div>
                                </td>
                                <td data-label="LONGITUDE">
                                    <div id="longitude">106.821397</div>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <img src="<?= asset('img/maps-drawing-1.png') ?>" alt="" style="width: 100%; text-align: center; margin-bottom: 20px; height: 500px;">
                </div>
            </div>

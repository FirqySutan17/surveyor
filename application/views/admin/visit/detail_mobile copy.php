                ...
                <div class="table-it">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <?= date('Y-m-d', strtotime($vr['TRANSDATE_OPEN'])) ?>
                                </td>
                                <td>
                                    <?= date('Y-m-d', strtotime($vr['TRANSDATE_CLOSE'])) ?>
                                </td>
                                <td>
                                    <?= $vr['CLOSE_TYPE'] ?>
                                </td>
                                <td>
                                    Rp <?= number_format($vr['AR_STOP']) ?>
                                </td>
                                <td>
                                    Rp <?= number_format($vr['AR_CURRENT']) ?>
                                </td>
                                <td>
                                    Rp <?= number_format($vr['COLLATERAL_AMT']) ?>
                                </td>
                                <td>
                                    <?= $vr['COLLECTION_TYPE'] ?>
                                </td>
                    ...
                    <div class="wrapper-reason">
                        <div class="col-item table-responsive">
                            <table class="table table-bordered">
                                <tr>
                                    <th colspan="4" style="background-color: #E6E6E6; height: 40px !important">Person in Charge When Open / Penanggung Jawab ketika Open</th>
                                </tr>
                                    <tr>
                                ...
                                <?php foreach ($vr_assets as $v): ?>    
                                    <?php if ($v['CLASS1'] == 'CG'): ?>
                                        <tr>
                                            ...
                                            <td><?= $v['ASSET_TYPE'] ?></td>
                                            <td><?= $v['ASSET_SIZE'] ?></td>
                                            <td><?= number_format($v['ASSET_VALUE']) ?></td>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <?php if (!empty($vr_other_debts)): ?>
                                ...
                                <tr>
                                    <td><?= $v['CREDITOR'] ?></td>
                                    <td><?= number_format($v['CURRENT_DEBT']) ?></td>
                                    <td><?= $v['NOTES'] ?></td>
                                </tr>
                                <?php endforeach ?>
                            <?php endif ?>

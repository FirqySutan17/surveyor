...
<div class="main-content pre-posttest">
    <h3 class="card-title">
        <strong>Visit Data - Report by Customer</strong>
    </h3>
    <form class="form-horizontal" action="#" method="POST">
        <div class="row" style="padding: 0px 0px; border-bottom: 2px solid #000; padding-bottom: 8px;margin: 0px 0px; margin-bottom: 10px; ">
                ...
                <?php if (!empty($datatable)): ?>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center; vertical-align: middle;">
                            <a href="<?= admin_url('visit/edit-customer/'.$v['SALES_ORG'].$v['CUSTOMER']) ?>" class="btn btn-sm" title="Edit"><i class="fas fa-pen text-warning"></i></a>
                            <a href="<?= admin_url('visit/detail-customer/'.$v['SALES_ORG'].$v['CUSTOMER']) ?>" target="_blank" class="btn btn-sm" title="Detail"><i class="fas fa-eye text-primary"></i></a>
                            <a href="<?= admin_url('visit/export-customer/'.$v['SALES_ORG'].$v['CUSTOMER']) ?>" class="btn btn-sm" title="Export"><i class="fas fa-download text-success"></i></a>
                        </td>
                    </tr>
                    <?php endforeach ?>
                <?php endif ?>

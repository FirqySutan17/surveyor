            ...
            <div id="main" class="main open-main">
                ...
                <script type="text/javascript">
                    ...
                    function addCollectionPlan() {
                        let tabledata = `
                            <tr>
                                <td><input type="month" name="CL_collection_date[]" class="form-control"></td>
                                <td><input type="text" name="CL_amount[]" class="form-control" onkeyup="onkeyup_data(event)" onkeydown="onkeydown_data(event)"></td>
                                <td><input type="text" name="CL_ar_balance[]" class="form-control" onkeyup="onkeyup_data(event)" onkeydown="onkeydown_data(event)"></td>
                                <td><input type="text" name="CL_note[]" class="form-control"></td>
                                <td><a onclick="deleteRow(this)" href="javascript:void(0)" class="btn btn-sm" title="Hapus"><i class="fas fa-trash text-danger"></i></a></td>
                            </tr>
                        `;
                    ...
                    function addOtherDebt() {
                        let tabledata = `
                            <tr>
                                <td><input type="text" name="OT_creditor[]" class="form-control"></td>
                                <td><input type="text" name="OT_current_debt[]" class="form-control" onkeyup="onkeyup_data(event)" onkeydown="onkeydown_data(event)"></td>
                                <td><input type="text" name="OT_note[]" class="form-control"></td>
                                <td><a onclick="deleteRow(this)" href="javascript:void(0)" class="btn btn-sm" title="Hapus"><i class="fas fa-trash text-danger"></i></a></td>
                            </tr>
                        `;
                    ...
                    function addVisitDetail() {
                        let tabledata = `
                            <tr>
                                <td><input type="date" name="VD_visit_date[]" class="form-control"></td>
                                <td><input type="text" name="VD_participant_cj[]" class="form-control"></td>
                                <td><input type="text" name="VD_participant_customer[]" class="form-control"></td>
                                <td><input type="text" name="VD_location[]" class="form-control"></td>
                                <td><textarea type="text" name="VD_description[]" class="form-control" rows="3" style="font-size: 10px"></textarea></td>
                                <td><textarea type="text" name="VD_collection_bd_opinion[]" class="form-control" rows="3" style="font-size: 10px"></textarea></td>
                                <td><a onclick="deleteRow(this)" href="javascript:void(0)" class="btn btn-sm" title="Hapus"><i class="fas fa-trash text-danger"></i></a></td>
                            </tr>
                        `;
                    ...
                    function addImages() {
                        let tabledata = `
                            <tr>
                                <td><input type="text" name="VR_image_name[]" class="form-control" placeholder="Type here.."></td>
                                <td><input type="file" accept="image/png, image/jpeg, image/jpg" name="VR_image_file[]" class="form-control"></td>
                                <td><a onclick="deleteRow(this)" href="javascript:void(0)" class="btn btn-sm" title="Hapus"><i class="fas fa-trash text-danger"></i></a></td>
                            </tr>
                        `;
                    ...
                    function addStrategy() {
                         ...
                         let tabledata = `
                            <tr>
                                <td width="45%"><textarea name="VR_strategy_sales[]" style="width: 100%; border-radius: 5px; padding: 10px" placeholder="Type here.." id="" rows="5" maxlength="500"></textarea></td>
                                <td width="50%"><textarea name="VR_strategy_cct[]" style="width: 100%; border-radius: 5px; padding: 10px" placeholder="Type here.." id="" rows="5" maxlength="500"></textarea></td>

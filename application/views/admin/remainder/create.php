...
<div class="main-content pre-posttest">
    <h3 class="card-title">
        <strong>Remainder Entry</strong>
    </h3>
    <div class="row">
        <form action="<?= admin_url('remainder/do_create') ?>" method="POST" enctype="multipart/form-data">
            <div class="content-task">
                <div class="row">
                    <div class="col-md-4 col-sm-12">
                        <div class="form-group row">
                            <label for="customer" class="col-lg-12 col-sm-12 col-form-label">Type</label>
                            <div class="col-lg-12 col-sm-12">
                                <select id="remainder_type" name="remainder_type" class="form-control">
                                    <option value="DAILY">DAILY REMAINDER</option>
                                    <option value="MONTHLY">MONTHLY REMAINDER</option>
                                </select>
                            </div>
                        </div>
                    </div>
